...
export const MOCK_ORDERS: Order[] = [
  { id: 'ORD-001', customerId: 'C1', customerName: 'Raj Kumar', items: [{ productId: 'P1', quantity: 2, price: 29.99 }], status: 'Delivered', total: 59.98, createdAt: '2024-03-15T15:20:00Z', paymentMode: 'COD' },
  { id: 'ORD-002', customerId: 'C2', customerName: 'Anita Desai', items: [{ productId: 'P2', quantity: 1, price: 54.99 }], status: 'Shipped', total: 54.99, createdAt: '2024-03-18T12:00:00Z', paymentMode: 'COD' },
  { id: 'ORD-003', customerId: 'C3', customerName: 'Vikram Singh', items: [{ productId: 'P4', quantity: 3, price: 24.99 }], status: 'Processing', total: 74.97, createdAt: '2024-03-20T16:45:00Z', paymentMode: 'COD' },
];
